/// @file realgarchfun.hpp
#ifndef realgarchfun_hpp
#define realgarchfun_hpp

#undef TMB_OBJECTIVE_PTR
#define TMB_OBJECTIVE_PTR obj

template<class Type>
Type realgarchfun(objective_function<Type>* obj) {
    DATA_VECTOR(y);
    ...
    // persistence
    Type persistence = gamma * alpha.sum() + beta.sum();
