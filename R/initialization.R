                               ...
                               distribution = "norm", ...)
{
    ...
    if (order[1] == 0) {
        ...
        parmatrix <- rbind(parmatrix,
                           data.table("parameter" = "ksi", value = 1,
                                      lower = 1e-12, upper = 5, estimate = 0,
                                      scale = 1, group = "real",
                                      equation = "[ARCH]", symbol = "\\ksi"))

        parmatrix <- rbind(parmatrix,
                           data.table("parameter" = "gamma", value = 1,
                                      lower = 0.01, upper = 5, estimate = 0,
                                      scale = 1, group = "real",
                                      equation = "[ARCH]", symbol = "\\gamma"))
        parmatrix <- rbind(parmatrix,
                           data.table("parameter" = "eta1", value = 0.1,
                                      lower = -0.5, upper = 0.5, estimate = 0,
                                      scale = 1, group = "real",
                                      equation = "[ARCH]", symbol = "\\eta_1"))
        parmatrix <- rbind(parmatrix,
                           data.table("parameter" = "eta2", value = 0.05,
                                      lower = -0.5, upper = 0.5, estimate = 0,
                                      scale = 1, group = "real",
                                      equation = "[ARCH]", symbol = "\\eta_2"))
        ...
        parmatrix <- rbind(parmatrix,
                           data.table("parameter" = "ksi", value = 1,
                                      lower = 1e-12, upper = 5, estimate = 1,
                                      scale = 1, group = "real",
                                      equation = "[ARCH]", symbol = "\\ksi"))

        parmatrix <- rbind(parmatrix,
                           data.table("parameter" = "gamma", value = 1,
                                      lower = 0.01, upper = 5, estimate = 1,
                                      scale = 1, group = "real",
                                      equation = "[ARCH]", symbol = "\\gamma"))
        parmatrix <- rbind(parmatrix,
                           data.table("parameter" = "eta1", value = 0.1,
                                      lower = -0.5, upper = 0.5, estimate = 1,
                                      scale = 1, group = "real",
                                      equation = "[ARCH]", symbol = "\\eta_1"))
        parmatrix <- rbind(parmatrix,
                           data.table("parameter" = "eta2", value = 0.05,
