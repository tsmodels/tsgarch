...
[![Last-changedate](https://img.shields.io/badge/last%20change-2026--09--11-yellowgreen.svg)](/commits/master)
...
- it does not implement joint ARFIMA-GARCH estimation, but does allow
  ...
  argument to `garch_modelspec`, for all models except `igarch`/`ewma`)
  in addition to the constant. With so many options for modelling the
