...
specified convention had the higher likelihood in every one of 1000
replications. That is worth doing rather than guessing, because choosing
wrongly biases the autoregressive coefficient by roughly $\pm 0.36$ on a
true value of 0.6, and depending on how persistent the regressor is, the
error may land on $\tau$ or on $\phi$ - so a plausible looking regressor
